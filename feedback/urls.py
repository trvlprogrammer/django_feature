...
urlpatterns = [
    ...
    path("feature/list/<str:state>", views.feature_list, name="feature-list"),
    ...
    path("feature-by-tag/list/<int:pk>/<str:state>", views.list_feature_by_tag, name="list-feature-by-tag"),
    path("feature-by-user/<int:pk>", views.get_feature_by_user, name="feature-by-user"),
    path("feature-by-user/list/<int:pk>/<str:state>", views.list_feature_by_user, name="list-feature-by-user"),
]
